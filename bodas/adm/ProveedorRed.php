<?php 
	...
	$objProveedoresRedes = new ProveedoresRedes();
?>
    ...
    <body>
    	<div class="contenedor-principal">
        	...
        	<div class="cuerpo">
                ...
                <div class="contenido">
                	<div class="opciones_internas"><?php $objProveedoresRedes->cabecera(); ?></div>
                    <div class="contenido_interno">
					<?php
						switch($_GET['opcion']){
							case 'nuevo':
								$objProveedoresRedes->nuevo();
							break;
							case 'add_new':
								$objProveedoresRedes->agregar();
								$objProveedoresRedes->nuevo();
							break;
							case 'add_list':
								$objProveedoresRedes->agregar();
								$objProveedoresRedes->listar();
							break;
							case 'editar':
								$objProveedoresRedes->editar($_GET['id']);	
							break;
							case 'actualizar':												
								$objProveedoresRedes->actualizar($_GET['id']);
								$objProveedoresRedes->listar();
							break;
							case 'eliminar':
								$objProveedoresRedes->eliminar($_GET['id']);
								$objProveedoresRedes->listar();
							break;
							default:
								$objProveedoresRedes->listar();
