...
sLengthMenu:"Mostrar grupos de _MENU_ registros.",sZeroRecords:"No se encontraron registros.",sEmptyTable:"No hay informacion disponible en la tabla.",sInfo:"Mostrar _START_ de _END_ del total _TOTAL_ registros.",sInfoEmpty:"Mostrar 0 de 0 del total de 0 registros.",sInfoFiltered:"(Filtrado de _MAX_ registros en total.)",sInfoPostFix:"",sSearch:"Buscar:",sUrl:"",oPaginate:{sFirst:"Primero",sPrevious:"Anterior",sNext:"Siguiente",sLast:"Ultimo"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=[];this.aoColumns=[];this.iNextId=0;this.asDataSearch=
