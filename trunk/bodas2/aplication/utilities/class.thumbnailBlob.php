...
class ThumbnailBlob{
	...
	*/
	...
	function CreateThumbnail($width=0, $height=0, $cod){		
		...
		if($width > 0 || $height > 0 ){
			...
			if(!empty($this->image)){		
				...
				imagejpeg($this->thumbnail, '../aplication/webroot/imgs/catalogo/thumb_'.$cod.strtolower($this->name), 98);
