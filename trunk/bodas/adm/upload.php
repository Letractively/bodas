<?php
	...
	}else if(isset($_GET['articulos_fotos'])){
		$img = $objUtilitarios->subirImagenCarpeta($_FILES['Filedata']['tmp_name'], $_FILES['Filedata']['name'], 'articulos_fotos');
		$obj = new ArticuloGaleria();
		echo $obj->agregarFotos($img, $_GET['id_articulo']);
	}
?>