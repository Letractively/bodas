<?php
	class VwJoyeriaYAccesorios extends Utiles{

		public function __construct(){}

		public function vista(){
			$objArticulo = new Articulo;
			$aryNoticias = $objArticulo->getArticuloXTipo(14);
			...
			?>
				<div class="margen-index">
                    ...
                    <div class="contenido-central-temas">
						...
						<div class="titulo">
                        	<p class="nombre-rubro">Joyeria y accesorios</p>
                            <p class="regresar">

                                <div class="contenedor-paginacion">
                                    <div class="paginacion">
                                        <a href="<?=_bs_?>joyeria-y-accesorios/0/">&laquo;</a>
                                        <?php for($x = 0 ; $x < count($listaPaginas) ; $x++){ ?>
                                            <a href="<?=_bs_?>trajes-de-novio/<?php echo $x ?>/"><?php echo ($x+1); ?></a>
                                        <?php } ?>
                                        <a href="<?=_bs_?>joyeria-y-accesorios/<?php echo count($listaPaginas)-1; ?>/">&raquo;</a>
                                    </div>
                                </div>
						...
						<div class="imagen-principal"><img src="<?php echo _img_?>joyeria-accesorios.jpg"></div>
						...
						<?php if(count($aryNoticias) > 0){ ?>
                            ...
                            <div class="listado-noticias">
                                ...
                                <?php for($x = 0 ; $x < count($aryPagina) ; $x++){?>
                                    <div class="item">
                                        <div class="imagen"><a href="<?=_bs_?>joyeria-y-accesorios-detalle/<?php echo $aryPagina[$x]['id']?>/<?php echo $objUtilitarios->procesar_url_2($aryPagina[$x]['titulo']) ?>"><img src="<?=_tt_."src=/aplication/webroot/imgs/articulos_fotos/".$aryPagina[$x]['imagen']."&w=190&h=132";?>"></a></div>
                                        <div class="texto">
                                        	<p class="fecha-item"><?php echo $this->formatear_fecha($aryPagina[$x]['fecha']); ?></p>
                                        	<p class="titulo-item"><b><a href="<?=_bs_?>joyeria-y-accesorios-detalle/<?php echo $aryPagina[$x]['id']?>/<?php echo $objUtilitarios->procesar_url_2($aryPagina[$x]['titulo']) ?>"><?php echo $aryPagina[$x]['titulo'] ?></a></b></p>
                                            <p><?php echo substr($aryPagina[$x]['descripcion1'],0,120); ?> <a href="<?=_bs_?>joyeria-y-accesorios-detalle/<?php echo $aryPagina[$x]['id']?>/<?php echo $objUtilitarios->procesar_url_2($aryPagina[$x]['titulo']) ?>">Ver más</a></p>
                                        </div>
                                    </div>
                                <?php } ?>
		...
		public function detalle(){
			...
			$aryArticulosRelacionados = $objArticulo->getArticuloXTipo(14);
				...
				<div class="margen-index">
                    ...
                    <div class="contenido-central-detalle-noticias">
						...
						<div class="titulo">
                            <p class="regresar">
                                <div class="contenedor-paginacion">
                                    <a href="<?=_bs_?>joyeria-accesorios/0/">&lt; Regresar a Joyeria y accesorios</a>
                                </div>
                            </p>
                        </div>
                        ...
                        <div class="mas-noticias">
                        	...
                        	<?php for($z = 0 ; $z < 3 ; $z++){ ?>
                            	<div class="item">
                                	<p><a href="<?=_bs_?>joyeria-accesorios-detalle/<?php echo $aryArticulosRelacionados[$z]['id']?>/<?php echo $objUtilitarios->procesar_url_2($aryArticulosRelacionados[$z]['titulo']) ?>"><img src="<?=_tt_."src=/aplication/webroot/imgs/articulos_fotos/".$aryArticulosRelacionados[$z]['imagen']."&w=145&h=86";?>"></a></p>
                                    <p><a href="<?=_bs_?>joyeria-accesorios-detalle/<?php echo $aryArticulosRelacionados[$z]['id']?>/<?php echo $objUtilitarios->procesar_url_2($aryArticulosRelacionados[$z]['titulo']) ?>"><?php echo $aryArticulosRelacionados[$z]['titulo']; ?></a></p>
                                </div>
                            <?php } ?>
                            </div>
                        </div>
